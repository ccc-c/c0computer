...
entry:
  %0 = load ptr, ptr @stderr
  %1 = getelementptr ([23 x i8], ptr @.str.0, i32 0, i32 0)
  %2 = call i32 (ptr, ptr, ...) @fprintf(ptr %0, ptr %1)
  ret i32 0
  ret i32 0
}

@.str.0 = private unnamed_addr constant [23 x i8] c"DEBUG: parsing struct\0A\00", align 1
