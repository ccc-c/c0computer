...
typedef enum {
    TK_EOF, TK_INT, TK_CHAR, TK_VOID, TK_STRUCT, TK_TYPEDEF, TK_RETURN, TK_IF, TK_ELSE, TK_WHILE, TK_FOR, TK_DO,
    ...
    TK_EQ = 257, TK_NE, TK_LE, TK_GE, TK_ANDAND, TK_OROR, TK_PLUSPLUS, TK_MINUSMINUS, TK_PLUSEQ, TK_ARROW
} TokenType;
