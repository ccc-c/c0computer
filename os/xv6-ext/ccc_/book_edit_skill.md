...
- **xv6-ext**：從 xv6-riscv-net 分支我們的專案，新增 httpd、curl、telnetd
...
```bash
# 搜尋 xv6-riscv-net
grep -r "xv6-riscv-net" /mnt/macos/c0computer/os/xv6-ext

# 搜尋 xv6-ext
grep -r "xv6-ext" /mnt/macos/c0computer/os/xv6-ext-book
```

### 2. 判斷哪些需要修正

- **測試腳本** (*.sh)：是我們專案的測試，應使用 xv6-ext
- **README.md**：是我們的專案，應使用 xv6-ext（但 git clone 指令保留原始專案名稱）
...
```bash
cd /mnt/macos/c0computer/os/xv6-ext
